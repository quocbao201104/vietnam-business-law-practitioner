...
4. **Map actor relationships.** Distinguish owner, shareholder/member, manager, legal representative, employee, delegate, parent, subsidiary, affiliate, branch, or external agent without assuming authority.
...
7. **Hand off only resolved state.** Authority questions go to BL2 authority; transaction questions go to BL3; foreign-investment consequences go to BL8.
...
- group relationship may require ownership records and corporate documents;
...
Provide corporate entity, cap-table/ownership records, and corporate control facts. BL8 owns foreign-investor/control tests and market-access consequences.
