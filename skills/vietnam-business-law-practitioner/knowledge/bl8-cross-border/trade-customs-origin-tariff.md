...
Determining goods-trade and border/customs propositions for actual or planned movement of goods across borders, including trade-policy route, customs role, HS classification, origin, valuation/tariff consequences, preferential treatment, and customs-state questions.

This unit owns **trade/customs/HS/origin/tariff propositions**. It does not decide domestic market/product permission, private contract obligations, tax treatment outside customs/trade ownership, or treat a product name/Incoterm as sufficient technical classification.
...
- non-customs tax treatment — BL5;
- corporate/importer entity authority — BL2;
- foreign-investment market access, governing law/treaty/CISG, or FX/payment propositions owned by other BL8 units.
...
- customs valuation or customs-specific base/charge where within BL8 trade ownership;
...
### FTA/treaty exists ≠ preferential tariff entitlement
...
### Classification ≠ valuation ≠ tariff ≠ final landed economics
...
- customs valuation;
- tariff/preference;
- customs-specific taxes/charges where material;
- BL5 non-customs tax consequences;
...
4. **Resolve product facts before technical classification.** Identify composition/function/form/use/specification facts needed for HS or other classification.
5. **Resolve the smallest necessary chain.** Trade-policy → HS → origin → valuation/tariff → customs process only as material; do not force every stage for every question.
6. **Invoke specialist depth where technical classification requires it.** Specialist remains owner-bound to BL8.
7. **Resolve current/historical authority.** Bind to import/export/declaration/entry temporal anchor.
8. **Separate border result from domestic market permission.** Late-route/consume BL7 where product approval/safety/label/sale permission is material.
9. **Commit BL8 trade state.** Supported, conditional, verify, blocked, disputed, or unresolved.
10. **Hand tax/payment/contract consequences outward.** BL5, FX unit, BL3 as appropriate without rewriting their state.
...
- FTA/preferential tariff schedules/status;
...
Provide committed customs/trade classifications and values where BL5 tax treatment depends on them. BL5 owns non-customs statutory tax consequences.
