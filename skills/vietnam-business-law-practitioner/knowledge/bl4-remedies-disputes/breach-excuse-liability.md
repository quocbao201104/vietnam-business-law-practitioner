...
Determining whether a committed BL3 obligation/performance deviation supports a breach/liability proposition, including materiality, attribution, contractual/statutory excuse, force-majeure/hardship-type issues, risk allocation, and other defenses that affect liability.
...
- remedy selection, damages quantum, penalty, interest, mitigation consequence — `remedies-loss-mitigation.md`;
...
- contractual exclusion/limitation/risk-allocation term that may affect liability.
...
A force-majeure, exclusion, limitation, indemnity, risk-transfer, or warranty clause is BL3 content. BL4 determines the liability consequence under the applicable regime.
...
6. **Test excuse/defense/risk allocation.** Use live authority and contractual terms where necessary.
...
9. **Hand off remedy questions.** If liability/remedy becomes material, `remedies-loss-mitigation.md` consumes the committed proposition.
...
- legal effect of exclusion/limitation/risk-allocation terms;
...
Provide breach/liability/materiality/excuse status plus the exact upstream obligation and temporal anchor. Do not pre-select the remedy.
